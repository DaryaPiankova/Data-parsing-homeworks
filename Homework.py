...
Выберите публичный API, который вас интересует, и потренируйтесь делать API-запросы 
с помощью Postman. Поэкспериментируйте с различными типами запросов и попробуйте 
получить различные типы данных.
...
if response.status_code == 200:
    ...
    for venue in venues:
        ...
        rate = venue.get("rating", "Рейтинг не указан")

        venues_data.append({"Название": name, "Адрес": address, "Рейтинг": rate})
